/*
	Bryan Bonilla Diaz (lunzyde) - Portfolio [NavMob_Work.js]
		...
		// Panel.
			$(
				'<div id="navPanel">' + '<nav>' +
					...
					'<a class="link depth-1"><span class="indent-0"></span><i class="fas fa-briefcase" aria-hidden="true"></i> Work</a>' +
						'<a class="link depth-0" href="#projects"><span class="indent-1"></span>Projects</a>' +
						'<a class="link depth-0" href="#prototypes"><span class="indent-1"></span>Prototypes</a>' +
