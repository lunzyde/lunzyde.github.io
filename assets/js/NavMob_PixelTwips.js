/*
	Bryan Bonilla Diaz (lunzyde) - Portfolio [NavMob_PixelTwips.js]
			...
			$(
				'<div id="navPanel">' + '<nav>' +
					...
					'<a class="link depth-0" href="/work.html"><span class="indent-0"></span><i class="fas fa-briefcase" aria-hidden="true"></i> Work</a>' +
						'<a class="link depth-1"><span class="indent-1"></span><i class="fas fa-gamepad" aria-hidden="true"></i> PixelTwips</a><hr class="nav">' +
							'<a class="link depth-0"><span class="indent-2"></span>Systems Breakdown</a>' +
                        	'<a class="link depth-0"><span class="indent-2"></span>UI Design Process</a>' +
